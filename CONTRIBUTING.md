...
6. **Update the README** if your change is user-facing. Do not edit `releaseNotes.md` or the version number (`torchnep/__init__.py`): the maintainers write the release notes and bump the version when a release is cut.
