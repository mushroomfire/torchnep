...
6. **Update the documentation** (`docs/`) if your change is user-facing. Do not edit `docs/release-notes.md` or the version number (`torchnep/__init__.py`): the maintainers write the release notes and bump the version when a release is cut.
